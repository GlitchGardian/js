...
console.table([accountId,accountBalance,Name,surname,accountOpenYear]);

//console.table is used for print the value of multiple variable

/*
Prefer not to use var
because of issue in block scope and functional scope
and this is multilin comment
*/